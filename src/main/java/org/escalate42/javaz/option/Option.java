 ...
 * on 8/20/14.
 */
public abstract class Option<T> implements Serializable, Monad<T, Option<?>> {

    private static final long serialVersionUID = 0;

    public static <U> Option<U> maybe(final U value) {
    ...
    @Override
    public <U> Option<U> pure(U value) { return maybe(value); }
