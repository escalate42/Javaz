 ...
 * on 11/6/14.
 */
public class ListMonoid<T> implements Monoid<List<T>, ListMonoid<T>> {
    ...
    @Override
    public MonoidOps<List<T>, ListMonoid<T>> ops() {
